...
/*Clases Abstractas 
 * Resumen: las clases abstactas, son aquellas las cuales son capaces de hacer pocas cosas contienen pocos metodos que permiten  hacer la comunicacion entre dos ramidificaciones, de las cuales permiten que una subclase que no tenga que ver con una ramidifizacion de herencia de clases peuda heredar algunos metodos de los cuales se peude ver beneficiado
 * Elquin Cascavita
...
namespace clases_abstractas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //----------------------------------------
            Console.WriteLine("se Prueba las clases abstractas ");
            ...
            //------------------------------------------
            Console.WriteLine("Comparacion con el metodo dabtracto");
            Juan.respirar();
            Juan.getNombre();
    ...
    class Lagartija : Animales
    {
        ...
        public override void getNombre()
        {
            ...
            Console.WriteLine("El nombre del reptir es: {0}", nombreReptil);
    ...
    //super clase ------------------------------------------
    class Mamiferos : Animales//super clase 
    {
        //campos de clase
        ...
        public override void getNombre()
        {
            Console.WriteLine("El nombre del mamifero es: {0}", nombreSerVivo);
        }
